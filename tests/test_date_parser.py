...
class TestDateParser(BaseTestCase):
    ...
    @parameterized.expand([
        ...
        param('5:4 am', datetime(2012, 11, 13, 5, 4)),
        param('1:4:5 am', datetime(2012, 11, 13, 1, 4, 5)),
        param('13:4:1 ', datetime(2012, 11, 13, 13, 4, 1)),
        param('12:4', datetime(2012, 11, 13, 12, 4)),
