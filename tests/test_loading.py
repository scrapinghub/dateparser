...
class TestLoading(BaseTestCase):
    ...
    def then_loaded_languages_are(self, loaded_languages):
        self.assertCountEqual(self, loaded_languages, self.data_loader._loaded_languages.keys())

    def then_loaded_locales_are(self, loaded_locales):
        self.assertCountEqual(self, loaded_locales, self.data_loader._loaded_locales.keys())
...
class TestLocaleDataLoader(BaseTestCase):
    ...
    def then_error_for_unknown_languages_raised(self, unknown_languages):
        ...
        self.assertCountEqual(self, languages, [repr(l) for l in unknown_languages])
    ...
    def then_error_for_unknown_locales_raised(self, unknown_locales):
        ...
        self.assertCountEqual(self, locales, [repr(l) for l in unknown_locales])
