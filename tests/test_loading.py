...
class TestLanguageDataLoader(BaseTestCase):
    ...
    @parameterized.expand([
        param(languages=['es','fr','en'], loaded_languages=['en','es','fr'], returned_languages=['en','es','fr']),
        param(languages=['ar','he'], loaded_languages=['en','ar','es','fr','he'], returned_languages=['ar','he']),
        param(languages=['tl','zh','uk'], loaded_languages=['en','ar','es','fr','he','tl','uk','zh'], returned_languages=['tl','uk','zh']),
        param(languages=['fr','zh','he','ru'], loaded_languages=['en','ar','es','fr','he','ru','tl','uk','zh'], returned_languages=['fr','he','ru','zh']),
    ])
