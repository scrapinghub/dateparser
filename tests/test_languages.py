...
class TestBundledLanguages(BaseTestCase):
    ...
    @parameterized.expand([
        ...
        # Korean
        param('ko', "오후 3시", "pm 3:00"),
        param('ko', "2시", "2:00"),
        param('ko', "11시 42분", "11:42"),
        param('ko', "3개월", "3 month"),
        param('ko', "약 53개월 전", "53 month ago"),
        param('ko', "3월", "march"),
        param('ko', "십이월", "december"),
        param('ko', "2월 10일", "2-10"),
        param('ko', "2013년 2월", "2013 year february"),
        param('ko', "2013년 04월 08일", "2013-04-08"),
        param('ko', "2016년 03월 24일 목요일 10시 05분", "2016-03-24 thursday 10:05"),
        param('ko', "2016년 3월 20일 21시 40분", "2016-3-20 21:40"),
        param('ko', "2016년 03월 21일 23시 05분 11초", "2016-03-21 23:05:11"),
        param('ko', "2016녀 3월 21일(월) 14시 48분", "2016-3-21 monday 14:48"),
        param('ko', "2016년 3월 20일(일) 21시 40분", "2016-3-20 sunday 21:40"),
        param('ko', "2016년 3월 20일 (일) 21시 40분", "2016-3-20 sunday 21:40"),
    ...
    @parameterized.expand([
        ...
        param('ko', "작년", "1 year ago"),
        param('ko', "17년 전", "17 year ago"),
        param('ko', "이번 달", "0 month ago"),
        param('ko', "저번 달", "1 month ago"),
        param('ko', "1개월 전", "1 month ago"),
        param('ko', "2개월 전", "2 month ago"),
        param('ko', "이번 주", "0 week ago"),
        param('ko', "지난 주", "1 week ago"),
        param('ko', "저번 주", "2 week ago"),
        param('ko', "2주 전", "2 week ago"),
        param('ko', "3주간", "3 week"),
        param('ko', "오늘", "0 day ago"),
        param('ko', "어제", "1 day ago"),
        param('ko', "그저께", "2 day ago"),
        param('ko', "3일전", "3 day ago"),
        param('ko', "1시간", "1 hour"),
        param('ko', "23시간 전", "23 hour ago"),
        param('ko', "30분", "30 minute"),
        param('ko', "3분간", "3 minute"),
        param('ko', "60초", "60 second"),
        param('ko', "3초전", "3 second ago"),
        param('ko', "현재", "0 second ago"),
        # Hebrew
