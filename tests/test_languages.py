...
class TestBundledLanguages(BaseTestCase):
    ...
    @parameterized.expand([
        ...
        # Italian
        param('it', "fra 3 minuti", "in 3 minute"),
        param('it', "5 giorni fa", "5 day ago"),
        param('it', "anno prossimo", "in 1 year"),
        param('it', "settimana scorsa", "1 week ago"),
        param('it', "20 anni a partire da ora", "in 20 year"),
        param('it', "altro ieri", "2 day ago"),
        param('it', "ieri", "1 day ago"),
        param('it', "oggi", "0 day ago"),
        param('it', "dieci min fa", "10 minute ago"),
        param('it', "2 settimane fa", "2 week ago"),
        param('it', "2 anni fa", "2 year ago"),
        param('it', "15 mesi fa", "15 month ago"),
        param('it', "51 min fa", "51 minute ago"),
        param('it', "tra 5 s", "in 5 second"),
        param('it', "settimana prossima", "in 1 week"),
        param('it', "5 mesi", "5 month"),
        param('it', "dom", "sunday"),
        param('it', "mercoledì", "wednesday"),
        param('it', "fra 23 ore", "in 23 hour"),
        param('it', "tra 3 h", "in 3 hour"),
        # Portuguese
