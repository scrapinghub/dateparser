...
class TestTranslateSearch(BaseTestCase):
    ...
    @parameterized.expand([
        ...
        param('ru', 'Андрей Дмитриевич Сахаров скончался 14 декабря в 1989 года, на 69-м году жизни от внезапной остановки сердца.',
              [('14 декабря в 1989 года', datetime.datetime(1989, 12, 14, 0, 0)),
               ('году', datetime.datetime(1989, 12, 14, 0, 0))]),
        # relative dates
